...
This implies that a given brain could have many different connectomes at different times, or at different resolutions, or of different types, etc.  Given these choices,  one can measure the parts of the brain to estimate their properties and activities.
